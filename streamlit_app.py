...
if not st.session_state.mode_selected:
    ...
    if st.button("Start Practice"):
        ...
        st.session_state.problem_list = random.sample(problems, len(problems)) if shuffle else problems.copy()
...
# Step 2: Practice Mode
    ...
    if st.session_state.lcm_index < len(st.session_state.problem_list):
